...
import com.example.huanpet.view.user.widget.OnWheelScrollListener;
...
class SelectorDateActivity extends Activity implements View.OnClickListener {
    ...
    public static void startActivity(Context context, String tit,
        ...
        title = tit;
        context.startActivity(new Intent(context, SelectorDateActivity.class));
    }
