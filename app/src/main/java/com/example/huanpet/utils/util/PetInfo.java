...
public class PetInfo implements Serializable {
	...
	public String toString() {
		return "PetInfo [id=" + id + ", petCode=" + petCode + ", petName=" + petName + ", userId=" + userId
				+ ", userName=" + userName + ", petSex=" + petSex + ", petBirthTime=" + petBirthTime + ", petInfo="
				+ petInfo + ", createTime=" + createTime + ", updateTime=" + updateTime + ", petImage=" + petImage
				+ ", petType=" + petType + ", petTypeName=" + petTypeName + ", isSterilization=" + isSterilization
				+ ", petWeight=" + petWeight + ", petPricingCode=" + petPricingCode + ", petState=" + petState
				+ ", isUse=" + isUse + ", isimmune=" + isimmune + ", petParentTypeCode=" + petParentTypeCode
				+ ", petParentTypeName=" + petParentTypeName + "]";
	}

	public void setPetWeight(String petweigth) {
	}
}
